    ...
    def action_print_claim_form(self):
        for order in self:
            if order.state == 'draft':
                # Primary print logic
                report_name = 'oxord_repair.report_primary_claim_form'
            else:
                # Secondary print logic
                report_name = 'oxord_repair.report_secondary_claim_form'

            return self.env.ref(report_name).report_action(order)
